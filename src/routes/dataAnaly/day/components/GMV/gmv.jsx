...
export default class Gmv extends Component {
  ...
  onFilterSubmit = (fields) => {
    ...
    dispatch({ type: 'day/queryBaseData', payload: { ...submitData, queryType:3 } });
  }
  ...
  render() {
    ...
    /* table列表*/
    const columns = [
      { title: '结算日期', dataIndex: 'checkInDate', key: 'checkInDate',
      width: '20%', }, 
      {
        title: '酒店名称',
        dataIndex: 'hotelName',
